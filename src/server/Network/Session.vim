...
vnoremap gs "xy:silent call Google(1)
nnoremap gs "xyiw:silent call Google(0)
map g[ :TagbarShowTag
...
map <F5> :w
map <silent> <F3> :BufferList
imap  :FufCoverageFile
inoremap  h
inoremap <NL> j
inoremap  k
inoremap  l
...
silent only
cd ~/workspace/Skypy/src/shared/ServerSocket
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +15 ServerSocket.cpp
badd +15 ServerSocket.hpp
badd +76 /usr/local/Cellar/boost/1.55.0/include/boost/bind/bind.hpp
badd +30 SessionSocket.hpp
badd +18 SocketMgr.hpp
badd +30 SocketMgr.cpp
badd +38 SessionSocket.cpp
badd +14 CMakeLists.txt
args ServerSocket.cpp
edit ServerSocket.cpp
...
22
normal! 018l
lcd ~/workspace/Skypy/src/shared/ServerSocket
wincmd w
argglobal
edit ~/workspace/Skypy/src/shared/ServerSocket/ServerSocket.cpp
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
setlocal autoindent
setlocal nobinary
...
exe 'vert 2resize ' . ((&columns * 96 + 97) / 194)
exe '3resize ' . ((&lines * 10 + 24) / 48)
tabedit ~/workspace/Skypy/src/shared/ServerSocket/ServerSocket.hpp
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd w
argglobal
edit ~/workspace/Skypy/src/shared/ServerSocket/SocketMgr.cpp
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
setlocal autoindent
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 28 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
...
exe 'vert 2resize ' . ((&columns * 96 + 97) / 194)
exe '3resize ' . ((&lines * 10 + 24) / 48)
tabedit ~/workspace/Skypy/src/shared/ServerSocket/CMakeLists.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
